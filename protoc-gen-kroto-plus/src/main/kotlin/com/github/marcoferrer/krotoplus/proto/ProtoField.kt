...
fun DescriptorProtos.FieldDescriptorProto.getParamaterizeTypeName(schema: Schema): TypeName =
    when {
        isMapField(schema) -> {
            ...
            Map::class.parameterizedBy(keyCn::class, valueCn::class)
        }
        label == LABEL_REPEATED -> {
            List::class.parameterizedBy(getFieldClassName(schema)::class)
        }
